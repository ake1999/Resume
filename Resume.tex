...
\renewcommand{\maketitle}
{
	    ...
	    \begin{flushleft}
                ...
                
                {
                    ...
                    {\small\bfseries Commanda Way, Ottawa K1M 1E7}
                }
                \hfill
...
\begin{document}
    ...
    \section{Summary of Qualifications}
        ...
        \paragraph{Excellent range of expertise in robotics to completely comprehend the enormous robotic projects and prepare for them within the minimum timeframe.}
    \section{Education}
